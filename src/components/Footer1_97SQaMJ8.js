...
const Footer1_97SQaMJ8 = () => {
	return (
		<section className="ezy__footer1_97SQaMJ8">
			<Container>
				<Row className="d-flex justify-content-between align-items-center">
					...
					<Col lg={4}>
						<Nav className="ezy__footer1_97SQaMJ8-nav justify-content-center">
					...
					>
						<Nav className="ezy__footer1_97SQaMJ8-social">
...
export default Footer1_97SQaMJ8;
